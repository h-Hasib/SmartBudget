...
type Props = {
  route: RouteProp<RootStackParamList, 'EmailSetupOtpScreen'>;
};
...
const EmailSetupOtpScreen = ({ route }: Props) => {
  ...
  const handleSubmit = (values: FormValues) => {
    try {
      ...
      navigation.navigate('SetPasswordScreen', { email: email });
    } catch (error) {
...
export default EmailSetupOtpScreen;
